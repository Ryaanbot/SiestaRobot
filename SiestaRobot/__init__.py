...
def get_user_list(__init__, key):
    with open("{}/Gabut Protection/{}".format(os.getcwd(), __init__), "r") as json_file:
...
LOGGER.info("Gabut Protection is starting. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: @gabutjoinsink (t.me/rommelxx)")
